...
#define GLUEPAR(p) (EQTB_ENTRY(GLUE_BASE + GLUE_PAR__##p).b32.s1)
#define SKIP_REG(n) (EQTB_ENTRY(SKIP_BASE + (n)).b32.s1)
#define MU_SKIP_REG(n) (EQTB_ENTRY(MU_SKIP_BASE + (n)).b32.s1)
#define LOCAL(p) (EQTB_ENTRY(LOCAL_BASE + LOCAL__##p).b32.s1)
#define TOKS_REG(n) (EQTB_ENTRY(TOKS_BASE + (n)).b32.s1)
#define ETEX_PENALTIES_PAR(p) (EQTB_ENTRY(ETEX_PEN_BASE + ETEX_PENALTIES_PAR__##p).b32.s1)
#define BOX_REG(n) (EQTB_ENTRY(BOX_BASE + (n)).b32.s1)
#define MATH_FONT(n) (EQTB_ENTRY(MATH_FONT_BASE + (n)).b32.s1)
#define CAT_CODE(n) (EQTB_ENTRY(CAT_CODE_BASE + (n)).b32.s1)
#define LC_CODE(n) (EQTB_ENTRY(LC_CODE_BASE + (n)).b32.s1)
#define UC_CODE(n) (EQTB_ENTRY(UC_CODE_BASE + (n)).b32.s1)
#define SF_CODE(n) (EQTB_ENTRY(SF_CODE_BASE + (n)).b32.s1)
#define MATH_CODE(n) (EQTB_ENTRY(MATH_CODE_BASE + (n)).b32.s1)
#define INTPAR(n) (EQTB_ENTRY(INT_BASE + INT_PAR__##n).b32.s1)
#define COUNT_REG(n) (EQTB_ENTRY(COUNT_BASE + (n)).b32.s1)
#define DEL_CODE(n) (EQTB_ENTRY(DEL_CODE_BASE + (n)).b32.s1)
#define DIMENPAR(n) (EQTB_ENTRY(DIMEN_BASE + DIMEN_PAR__##n).b32.s1)
#define SCALED_REG(n) (EQTB_ENTRY(SCALED_BASE + (n)).b32.s1)
