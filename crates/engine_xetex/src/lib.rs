...
pub mod c_api {
    ...
    pub struct XeTeXProfile {
        ...
        pub cleanup_us: u64,
        pub total_us: u64,
        pub heap_capacity_at_entry: u64,
        pub heap_live_at_entry: u64,
        pub heap_free_at_entry: u64,
        pub heap_arena_at_entry: u64,
        pub heap_capacity_after_setup: u64,
        pub heap_live_after_setup: u64,
        pub heap_free_after_setup: u64,
        pub heap_arena_after_setup: u64,
        pub heap_capacity_after_format: u64,
        pub heap_live_after_format: u64,
        pub heap_free_after_format: u64,
        pub heap_arena_after_format: u64,
        ...
        pub pool_used_after_format: u32,
        pub pool_capacity_after_format: u32,
        pub strings_used_after_format: u32,
        pub strings_capacity_after_format: u32,
        pub font_info_used_after_format: u32,
        pub font_info_capacity_after_format: u32,
        pub pool_used_at_end: u32,
        pub strings_used_at_end: u32,
        pub font_info_used_at_end: u32,
        pub eqtb_logical_pages: u32,
        pub eqtb_interned_pages: u32,
        pub eqtb_private_pages_after_format: u32,
        pub eqtb_private_pages_at_end: u32,
    }
